...
<body>
			...
			<div class="instafeed" id="instafeed">
				...
				<div class="insta-info">
					...
					<div class="insta-texts">
						<p class="insta-incentive">Publique sua foto com a #TPR2018</p>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="ranking">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12 rank r2">
				...
				<div class="col-sm-4 col-xs-12 rank r1">
				...
				<div class="col-sm-4 col-xs-12 rank r3">
